...
namespace Collatz_Conjecture
{
    public partial class ayarlar : Form
    {
        ...
        {
            if (MessageBox.Show(string.Format(da.KelimeAl("linkUyari"), "\"github.com/aeuludag/collatz\""), da.KelimeAl("collatzSanisi"), MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) == DialogResult.OK)
            {
                System.Diagnostics.Process.Start("https://github.com/aeuludag/collatz");
